...
from CodonTransformer.CodonData import (
    ORGANISM2ID2,ID2ORGANISM2
)
from latefusion_by_organism import split_dataset_by_organism
...
class plTrainHarness(pl.LightningModule):
    def __init__(self, model, tokenizer, learning_rate, warmup_fraction, config=None,
        ...
        excel_data = pd.read_excel('Codon_Frequency_Table.xlsx', index_col=0)
        self.codon_table = {}
...
class MyDataLoader(pl.LightningDataModule):
    def __init__(self, tv_dataset=None, te_dataset=None, collate_fn=None, batch_size=6,
    ...
    def test_dataloader(self) -> EVAL_DATALOADERS:
        return DataLoader(self.te_dataset, batch_size=self.batch_size,
                          collate_fn=self.collate_fn, num_workers=self.num_workers,
                          persistent_workers=self.persistent_workers)
...
def main(args):
    ...
    dataloader = MyDataLoader(
        tv_dataset=train_data,
        te_dataset=test_data,
        collate_fn=MaskedTokenizerCollator(tokenizer, prob=0.5),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default="dataset/testing_data.jsonl",
